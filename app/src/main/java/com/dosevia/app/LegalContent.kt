...
If you sign in with Google and enable backup/sync:
• Dosevia saves and restores your data using your Google Drive storage.
• Your backup is stored in your Google account (not on private developer servers).
