    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (notificationManager != null) {
                ...
                // Create main medication reminders channel
                String channelId = "dosevia_reminders";
                CharSequence name = "Medication Reminders";
                String description = "Medication reminders with alarm and vibration";
                ...
                // Create alarm service channel (low priority, for foreground service)
                NotificationChannel serviceChannel = new NotificationChannel(
                    "alarm_service_channel",
                    "Alarm Service",
                    NotificationManager.IMPORTANCE_LOW
                );
                serviceChannel.setDescription("Background service for alarm sound");
