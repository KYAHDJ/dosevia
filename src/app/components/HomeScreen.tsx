    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-orange-50 to-yellow-50">
      ...
      <div className="max-w-2xl mx-auto py-8">
        ...
        <div className="mt-6 px-4 grid grid-cols-3 gap-3">
          <button onClick={() => onNavigate('settings')} className="bg-white rounded-xl shadow-lg p-4">
            <Settings className="w-5 h-5" />
            <span>Settings</span>
          </button>

          <button onClick={() => onNavigate('history')} className="bg-white rounded-xl shadow-lg p-4">
            <History className="w-5 h-5" />
            <span>History</span>
          </button>

          <button onClick={() => onNavigate('stats')} className="bg-white rounded-xl shadow-lg p-4">
