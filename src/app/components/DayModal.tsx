            ...
            >
              ...
              <div className="p-6 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-4 px-6 rounded-xl font-semibold text-white transition-all active:scale-95"
                  style={{
                ...
                <button
                  ...
                  className="w-full py-4 px-6 rounded-xl font-semibold transition-all active:scale-95"
                  style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: '0 4px 12px rgba(250, 184, 109, 0.3)',
                  }}
                >
                  ⚠ Missed
                </button>
