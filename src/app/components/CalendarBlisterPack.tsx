      ...
      <div className="w-full max-w-md mx-auto px-3">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 15px 50px rgba(246, 9, 188, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.5)',
          }}
        >
                ...
                {column.map((dayData, rowIndex) => (
                  <div key={dayData.day} className="flex flex-col items-center">
                    ...
                    {rowIndex < column.length - 1 && (
                      <ChevronDown 
                        className="w-4 h-4 my-0.5 opacity-60"
                        style={{
                          color: dayData.isPlacebo ? '#fab86d' : '#f609bc',
                        }}
                      />
                    )}
                  </div>
